    ...
    <div className="mx-auto max-w-6xl">
      ...
      {images.length === 0 ? (
        ...
        <>
          ...
          <div className="sticky  z-30 -mx-4 mb-5 border-b border-border bg-paper/95 px-4 py-3 backdrop-blur-md sm:-mx-6 sm:px-6">
          ...
          <button
            ...
            className="mb-4 flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-border-strong bg-paper-raised px-4 mt-8  text-sm font-medium text-ink-soft transition-colors hover:bg-paper-sunken py-8"
          >
